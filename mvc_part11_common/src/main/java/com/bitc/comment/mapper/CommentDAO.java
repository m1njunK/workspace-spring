...
public interface CommentDAO {
	 ...
	 * @return - 삽입된 행의 개수
	 */
	@Insert("INSERT INTO re_tbl_comment(bno,commentText,commentAuth) VALUES(#{bno},#{commentText},#{commentAuth})")
	 ...
	 * @return  수정된 행의 개수
	 */
	@Update("UPDATE re_tbl_comment SET commentAuth = #{commentAuth}, commentText = #{commentText}, updatedate = now() WHERE cno = #{cno}")
	 ...
	 * @throws Exception
	 */
	@Select("SELECT * FROM re_tbl_comment WHERE bno = #{bno} ORDER BY cno DESC limit #{cri.startRow}, #{cri.perPageNum}")
